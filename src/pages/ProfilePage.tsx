    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <header className="sticky top-0 z-30 bg-black border-b border-[#1a1a1a]">
        <div className="max-w-2xl mx-auto px-4 py-2 relative flex items-center justify-center">
          ...
          <img src="/logo-banniere.png" alt="SPINCUT" style={{ height: '110px', objectFit: 'contain', mixBlendMode: 'screen', maskImage: 'radial-gradient(ellipse 95% 90% at 50% 50%, black 50%, transparent 100%)', WebkitMaskImage: 'radial-gradient(ellipse 95% 90% at 50% 50%, black 50%, transparent 100%)' }} />
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 pb-36 pt-6 space-y-4">
        ...
        <div className="rounded-xl bg-[#161616] border border-[#2a2a2a] p-4">
          ...
          {commPref === 'email' && (
            <p className="text-[10px] mt-2 text-center" style={{ color: '#2a2a8a' }}>✓ SPINCUT vous contactera par email</p>
          )}
        </div>
        ...
        <div className="rounded-xl bg-[#161616] border border-[#2a2a2a] overflow-hidden">
          ...
          >
            ...
            WhatsApp — 07 67 73 95 61
          </a>
          <button
            onClick={() => setShowMailMenu(true)}
            className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-white hover:bg-[#1a1a1a] transition-colors border-t border-[#1e1e1e] text-left"
          >
