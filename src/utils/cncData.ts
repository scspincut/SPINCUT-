...
export const MATERIAL_GUIDE: MatGuide[] = [
  ...
  { nom: 'Pin / Sapin / Épicéa', cat: 'Bois résineux',
    ...
    astuce: 'fz 2% D, Vc 350-600 m/min. Copeaux longs = bon signe.' },
  ...
  { nom: 'Bouleau', cat: 'Bois feuillus',
    z: 'Z=2-3', premier: ['carbure_monobloc'], aussi: ['compression', 'ravageuse'],
    eviter: 'HSS',
    astuce: 'Bois homogène, beau copeau. Standard.' },
  { nom: 'Aulne / Tilleul', cat: 'Bois feuillus',
    z: 'Z=2', premier: ['carbure_monobloc'], aussi: ['ravageuse'],
    eviter: '',
  ...
  { nom: 'Chêne', cat: 'Bois feuillus',
    z: 'Z=2-3', premier: ['carbure_monobloc', 'diamant_coupe'], aussi: ['ravageuse'],
    eviter: 'HSS inutilisable',
    astuce: 'Tanins agressifs. Vc -15% vs résineux. Aspiration.' },
  { nom: 'Frêne', cat: 'Bois feuillus',
    z: 'Z=2-3', premier: ['carbure_monobloc'], aussi: ['compression'],
    eviter: 'HSS',
    astuce: 'Fibres longues → aspiration. Carbure grain fin.' },
  { nom: 'Noyer / Merisier', cat: 'Bois feuillus',
    z: 'Z=2-3', premier: ['carbure_monobloc'], aussi: ['diamant_coupe'],
    eviter: '',
  ...
  { nom: 'Ébène / Bois de rose', cat: 'Bois exotiques',
    z: 'Z=1-2', premier: ['diamant_coupe', 'carbure_monobloc'], aussi: [],
  ...
  { nom: 'Contreplaqué peuplier', cat: 'Panneaux dérivés',
    z: 'Z=2-4', premier: ['compression', 'carbure_monobloc'], aussi: ['diamant_coupe'],
    eviter: '',
  ...
  { nom: 'Alu 2017A / 2024 (dural)', cat: 'Aluminium',
    z: 'Z=1-2', premier: ['carbure_monobloc'], aussi: ['ravageuse'],
    eviter: 'Diamant PCD, compression, HSS à sec',
    astuce: 'Microlubrification OBLIGATOIRE. Rampe hélicoïdale. En avalant uniquement.' },
  { nom: 'Alu 7075 (avionique)', cat: 'Aluminium',
    z: 'Z=1-2', premier: ['carbure_monobloc'], aussi: [],
  ...
  { nom: 'PVC expansé (Forex, Sintra)', cat: 'Plastiques',
    ...
    astuce: 'Polimiroir idéal. Basse broche + haute avance. fz 1.5-2% D. Air comprimé.' },
  { nom: 'PVC massif / rigide', cat: 'Plastiques',
    z: 'Z=1-2', pm: true, premier: ['carbure_monobloc'], aussi: [],
    eviter: 'Vc élevée',
    astuce: 'Polimiroir idéal. fz élevé, n modéré. Meilleur comportement que PVC expansé.' },
  { nom: 'PMMA / Acrylique', cat: 'Plastiques',
    z: 'Z=1', pm: true, premier: ['carbure_monobloc'], aussi: [],
    eviter: "EAU (fissuration), Vc élevée",
    astuce: 'Polimiroir 1 dent = résultat miroir. Air comprimé UNIQUEMENT. Arête parfaite obligatoire.' },
  { nom: 'Polycarbonate (PC)', cat: 'Plastiques',
    z: 'Z=1-2', pm: true, premier: ['carbure_monobloc'], aussi: [],
    eviter: '',
    astuce: 'Polimiroir recommandé. Matière gommeuse → fz élevé anti-bouchonnage.' },
  { nom: 'ABS', cat: 'Plastiques',
    z: 'Z=1-2', pm: true, premier: ['carbure_monobloc'], aussi: [],
    eviter: 'Vc élevée (fusion facile)',
    astuce: 'Polimiroir recommandé. fz élevé. Soufflage air.' },
  { nom: 'POM (Delrin) / Nylon', cat: 'Plastiques',
    z: 'Z=1-2', pm: true, premier: ['carbure_monobloc'], aussi: [],
    eviter: '',
    astuce: 'Polimiroir recommandé. POM = excellent comportement, copeau propre.' },
];
