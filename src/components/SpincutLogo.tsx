  ...
  return (
    <div className={`flex items-center ${gapClass}`}>
      <svg width={iconW} height={iconH} viewBox="0 0 42 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id={goldId} x1="4" y1="44" x2="38" y2="6" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id={topId} x1="30" y1="4" x2="8" y2="26" gradientUnits="userSpaceOnUse">
            <stop offset="0%"   stopColor="#f4f4f4"/>
            <stop offset="30%"  stopColor="#c8c8c8"/>
            <stop offset="70%"  stopColor="#808080"/>
            <stop offset="100%" stopColor="#404040"/>
          </linearGradient>
          <linearGradient id={botId} x1="12" y1="24" x2="34" y2="46" gradientUnits="userSpaceOnUse">
        ...
        <path
          ...
          stroke={`url(#${topId})`} strokeWidth="6" strokeLinecap="round" fill="none"
        />
        {/* Lower lobe of S (chrome) */}
        <path
          d="M 26 27 L 16 27 C 7 27 1 30 1 37 C 1 44 6 49 14 49"
          stroke={`url(#${botId})`} strokeWidth="6" strokeLinecap="round" fill="none"
        />
        {/* Chrome highlight */}
        <path
        ...
        <path
          ...
          stroke={`url(#${goldId})`} strokeWidth="4" strokeLinecap="round" fill="none"
        />
        {/* Gold shimmer */}
        <path
