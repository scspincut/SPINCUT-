...
export default function BottomNav({ cartCount = 0, cartTotal = 0 }: { cartCount?: number; cartTotal?: number }) {
  ...
  return (
    <>
      {/* Floating WhatsApp — commander directement */}
      <a
        href="https://wa.me/33767739561?text=Bonjour%20SPINCUT%2C%20je%20voudrais%20passer%20une%20commande"
        target="_blank"
        rel="noopener noreferrer"
        style={{ position: 'fixed', bottom: '86px', right: '16px', zIndex: 49, width: '54px', height: '54px', background: '#25D366', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 24px rgba(37,211,102,0.45)', transition: 'transform 0.15s' }}
